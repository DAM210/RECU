<?php
require_once __DIR__ . 'vendor/autoload.php'; // Carga la librería brick/math
...
class IBANValidar
{
    ...
    public static function validaIBAN($iban){
        ...
        /*if(strlen($iban)!=24){
            ...
            $cadena=(substr($iban,4,20).'142800');
            $numero=BigNumber::of($cadena);
            $cociente=$numero->dividedBy(97,RoundingMode::FLOOR);
