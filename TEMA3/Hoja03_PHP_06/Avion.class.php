...
class Avion extends ElementoVolador{
    ...
    public function mostrarInfo(){
        return "Nombre: ".$this->getNombre().". Nº alas: ".$this->getNumAlas().". Nº motores: ".$this->getNumMotores().". Altitud: ".$this->getAltitud().". Velocidad: ".$this->getVelocidad().". Compañia aérea: ".$this->companiaAerea.". Fecha de alta: ".$this->fechaAlta.".</br></br>";
    }
}
?>