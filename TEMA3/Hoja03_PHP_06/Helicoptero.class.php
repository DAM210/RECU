...
class Helicoptero extends ElementoVolador{
    ...
    public function mostrarInfo(){
        return "Nombre: ".$this->getNombre().". Nº alas: ".$this->getNumAlas().". Nº motores: ".$this->getNumMotores().". Altitud: ".$this->getAltitud().". Velocidad: ".$this->getVelocidad().". Propietario: ".$this->propietario.". Nº rotores: ".$this->numRotores.".</br></br>";
    }
}
?>