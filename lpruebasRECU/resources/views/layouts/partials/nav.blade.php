            ...
            <div class="flex flex-col text-center lg:flex-row">
                @if (Auth::check())
                    <a href="{{ route('profile.show') }}"
                        class="text-white mb-1 lg:mr-4 lg:mb-0">{{ Auth::user()->name }}</a>
                    <a href="{{ route('logout') }}" class="bblanco mb-1 lg:mr-4 lg:mb-0"
                ...
                @else
                    <a href="{{ url('login') }}" class="bblanco mb-1 lg:mr-4 lg:mb-0 btn btn-default">Iniciar
                        Sesion</a>
                @endif
